...
training_args = Seq2SeqTrainingArguments(
    output_dir="./fine_tuned_gpt2_spanish",
...
model.save_pretrained("./fine_tuned_gpt2_spanish")
tokenizer.save_pretrained("./fine_tuned_gpt2_spanish")

# tokenizer = T5Tokenizer.from_pretrained("./fine_tuned_gpt2_spanish")
# device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
# model = T5ForConditionalGeneration.from_pretrained("./fine_tuned_gpt2_spanish")
